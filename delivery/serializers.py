...
class StoreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Store
        fields = ['id', 'name', 'category', 'image', 'phone_number', 'password', 'available', 'country', 'governorate', 'latitude', 'longitude', 'items', 'ratings', 'average_rating', 'favorited_by', 'notices', 'gouvernorat', 'gouvernorat_name']
